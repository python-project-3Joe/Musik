...
class MyPage extends StatefulWidget {
  final Map users;
  const MyPage({Key? key, required this.users}) : super(key: key);
...
class _MyPageState extends State<MyPage> {
  ...
  void initState() {
    ...
    _idController.text = widget.users['u_id'];
    _pwController.text = widget.users['u_pw'];
    _nameController.text = widget.users['u_nickname'];
    _emailController.text = widget.users['u_email'];
